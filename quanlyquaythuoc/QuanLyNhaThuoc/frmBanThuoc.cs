        ...
        private void btnThemVaoHoaDon_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               for (int i = 0; i < dgvThuocTrongHoaDon.RowCount; i++)
                {
                    mat = dgvThuocTrongHoaDon.Rows[i].Cells[7].Value.ToString();
                    if (mat==lblMaThuoc.Text)
                    {
                        check = 0;
                    }
                }
                ...
                {
                    MessageBox.Show("Thuốc này đã có trong hóa đơn!","Thông báo");
                }
            ...
            if (dgvThuocTrongHoaDon.Rows.Count >0)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        MessageBox.Show("Không được để tiền khách thanh toán rỗng!");
                }
